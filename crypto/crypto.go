...
////
////const (
////	PaddingNone  = PaddingMode("NoPadding")
////	PaddingPKCS7 = PaddingMode("pkcs7Padding")
////	PaddingZero  = PaddingMode("zeroPadding")
////)
//
//var (
...
//
//	// OFB和CTR不需要填充
//	if c.BlockMode != BlockModeOFB && c.BlockMode != BlockModeCTR {
...
//			plainTxt = zeroPadding{}.Padding(plainTxt, block.BlockSize())
//		}
//	}
//
//	switch c.BlockMode {
...
//			}
//		case PaddingModeZero:
//			dst, err = zeroPadding{}.UnPadding(dst)
//			if err != nil {
//				return nil, err
//			}
//		}
